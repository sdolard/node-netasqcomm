...
describe('Firewall list format', function(){
	it(' should have a good render', function(done) {
		var
	...
	it ('should when parsing xml list format with multipe section', function(done) {
			var
			parser = xml2jsparser.create(),
			xml = [
				'<?xml version="1.0"?>',
