...
SessionDataResponse.prototype.dumpServerdData = function(ws, mode) {
	...
	if (!this.data || !this.data.nws) {
		return this._eexception({
				code: 'ENVALIDDATA',
				message: 'data is not valid'
		});
	}
	if (this.data.nws.serverd) {
		ws = ws || process.stdout;
		mode = mode || 'ini';
	...
	ws.write('nws code="' + this.data.nws.code + '" msg="' + this.data.nws.msg + '"\n');
};
...
SessionDataResponse.NWS_ERROR_CODE = {
	...
	EXPIRED_SESSION: 204,
	AUTH_ERROR: 205,
	DOWNLOAD_WAITING: 206,
	WAITING_FOR_UPLOAD: 207,
	SERVER_OVERLOADED: 500,
	SERVER_UNREACHABLE: 501,
...
* @consts
*/
SessionDataResponse.NWS_ERROR_CODE_MSG = {
	100: 'ok',
	200: 'request error',
	201: 'unknown action',
	202: 'action error',
	...
	204: 'expired session',
	205: 'auth error',
	206: 'download waiting',
	207: 'waiting for_upload',
	500: 'server overloaded',
	501: 'server unreachable',
	502: 'serverd disconnected',
	900: 'internal error' 
};
...
exports.NWS_ERROR_CODE_MSG = SessionDataResponse.NWS_ERROR_CODE_MSG;
