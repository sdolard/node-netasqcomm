/**
* Came from https://raw.github.com/isaacs/npm/master/lib/utils/prompt.js
*/
var buffer = ""
...
* @param {string} def > default value, if their is not key strike
* @param {boolean} silent > nothing printed to screen if true
* @param {function({})} 
*/
exports.prompt = function(p, def, silent, cb) {
